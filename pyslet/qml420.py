...
class QMLAnswer(QMLElement):
	...
	XMLATTR_COMMENTLABEL=('commentLabel',ParseMessageString,FormatMessageString)
	XMLATTR_COMMENTHEIGHT=('commentHeight',ParseCommentHeight,FormatCommentHeight)
	XMLATTR_COMMENTWIDTH=('commentWidth',ParseCommentWidth,FormatCommentWidth)
...
class QMLOutcome(QMLElement):
	...
	XMLATTR_CONTINTUE=('continueFlag',ParseTrueFalseEnum,FormatTrueFalseEnum)
