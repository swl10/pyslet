...
...................."""
        ...
        c = Coords(
            map(lambda x: LengthType(x, LengthType.Percentage), SAMPLE_RECT))
        result = []
        for y in xrange(18):
            s = []
            for x in xrange(20):
...
...................."""
        c = Coords(
            map(lambda x: LengthType(x, LengthType.Pixel), SAMPLE_CIRCLE))
        result = []
        for y in xrange(10):
            s = []
            for x in xrange(10):
        ...
        c = Coords(
            map(lambda x: LengthType(x, LengthType.Percentage), SAMPLE_CIRCLE))
        result = []
        for y in xrange(30):
            s = []
            for x in xrange(20):
    ...
    def testCaseCoordsPoly(self):
        SAMPLE_POLY = (3, 1, 1, 3, 2, 6, 3, 4, 5, 3, 6, 6, 4, 7, 7, 8, 9,
                       7, 8, 5, 11, 6, 13, 6, 14, 3, 12, 1, 12, 3, 10, 1, 7, 2, 3, 1)
        RESULT1 = """................
...+......+.+...
..#####*###.#...
.*###*######*#+.
...
................................"""
        ...
        c = Coords(
            map(lambda x: LengthType(x, LengthType.Percentage), SAMPLE_POLY))
        result = []
        for y in xrange(27):
            s = []
            for x in xrange(32):
