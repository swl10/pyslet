...
class CommonExpressionTests(unittest.TestCase):
    ...
    def testCaseEvaluateParenExpression(self):
        ...
        p = Parser(
            "(false and false or true)")		# note that or is the weakest operator
        e = p.ParseCommonExpression()
        value = e.Evaluate(None)
    ...
    def testCaseEvaluateEqExpression(self):
        ...
        self.assertTrue(value.value is True, "Expected True")
        value = self.EvaluateCommon(
            "guid'b3afeebc-9658-4699-9d9c-1df551fd6814' eq guid'3fa6109e-f09c-4c5e-a5f3-6cf38d35c9b5'")
        self.assertTrue(value.value is False, "Expected False")
    ...
    def testCaseEvaluateNeExpression(self):
        ...
        self.assertTrue(value.value is True, "Expected True")
        value = self.EvaluateCommon(
            "guid'b3afeebc-9658-4699-9d9c-1df551fd6814' ne guid'b3afeebc-9658-4699-9d9c-1df551fd6814'")
        self.assertTrue(value.value is False, "Expected False")
        value = self.EvaluateCommon(
            "guid'b3afeebc-9658-4699-9d9c-1df551fd6814' ne guid'3fa6109e-f09c-4c5e-a5f3-6cf38d35c9b5'")
        self.assertTrue(value.value is True, "Expected True")
    ...
    def testCaseEvaluateLtExpression(self):
        ...
        self.assertTrue(value.value is True, "Expected True")
        value = self.EvaluateCommon(
            "guid'b3afeebc-9658-4699-9d9c-1df551fd6814' lt guid'b3afeebc-9658-4699-9d9c-1df551fd6814'")
        self.assertTrue(value.value is False, "Expected False")
        value = self.EvaluateCommon(
            "guid'b3afeebc-9658-4699-9d9c-1df551fd6814' lt guid'3fa6109e-f09c-4c5e-a5f3-6cf38d35c9b5'")
        self.assertTrue(value.value is False, "Expected False")
        try:
    ...
    def testCaseEvaluateLiteralExpression(self):
        ...
        self.assertTrue(
            value.typeCode == edm.SimpleType.DateTimeOffset, "Expected DateTimeOffset")
        self.assertTrue(
            value.value == iso.TimePoint.FromString('2002-10-10T12:00:00-05:00'))
    ...
    def testCaseEvaluateYearExpression(self):
        ...
        for f, r in (
            ...
            try:
                value = self.EvaluateCommon(
                    "%s(datetime'2013-09-01T10:56',datetime'2013-09-01T10:57')" % f)
                self.fail("2 parameters")
            except EvaluationError:
                pass
    ...
    def testCaseStringConversionExpression(self):
        for example in [
            ...
            self.assertTrue(unicode(e1) == unicode(
                e2), "Unstable expression: %s, %s!=%s" % (example, unicode(e1), unicode(e2)))
...
class ODataURITests(unittest.TestCase):
    ...
    def testCaseConstructor(self):
        ...
        self.assertTrue(dsURI.navPath == [], "navPath: %s" %
                        repr(dsURI.navPath))
        dsURI = ODataURI('/', '/x')
        ...
        self.assertTrue(dsURI.pathPrefix == '/x', "non-empty path prefix")
        self.assertTrue(
            dsURI.resourcePath == '', "empty resource path, special case")
        self.assertTrue(
            dsURI.navPath == [], "empty navPath, special case: %s" % repr(dsURI.navPath))
        ...
        self.assertTrue(len(dsURI.navPath) == 1, "navPath: %s" %
                        repr(dsURI.navPath))
        self.assertTrue(
            type(dsURI.navPath[0][0]) is UnicodeType, "entity set name type")
        self.assertTrue(
            dsURI.navPath[0][0] == 'Products', "entity set name: Products")
        self.assertTrue(
            dsURI.navPath[0][1] == None, "entity set no key-predicate")
    ...
    def testCaseCommonExpressions(self):
        ...
        self.assertTrue(isinstance(dsURI.sysQueryOptions[
                        SystemQueryOption.filter], CommonExpression), "Expected common expression")
        dsURI = ODataURI("Products()?$filter=true%20and%20false", '/x.svc')
        f = dsURI.sysQueryOptions[SystemQueryOption.filter]
        self.assertTrue(
            isinstance(f, CommonExpression), "Expected common expression")
        self.assertTrue(
            isinstance(f, BinaryExpression), "Expected binary expression, %s" % repr(f))
        self.assertTrue(
            f.operator == Operator.boolAnd, "Expected and: %s" % repr(f.operator))
        try:
            dsURI = ODataURI(
    ...
    def testCaseEntitySet(self):
        ...
        self.assertTrue(set(dsURI.sysQueryOptions.keys()) == set([SystemQueryOption.format,
                                                                  SystemQueryOption.top, SystemQueryOption.skip]), repr(dsURI.sysQueryOptions))
        self.assertTrue(dsURI.queryOptions == ["space='%20'"], 'query options')
        self.assertTrue(dsURI.navPath == [
                        (u'Products', {})], "entity set: Products, found %s" % repr(dsURI.navPath))
        dsURI = ODataURI('Products()/$count', '/x.svc')
        self.assertTrue(
            dsURI.resourcePath == '/Products()/$count', "resource path")
        self.assertTrue(dsURI.sysQueryOptions == {}, 'sysQueryOptions')
        self.assertTrue(dsURI.queryOptions == [], 'query options')
        self.assertTrue(
            dsURI.navPath == [(u'Products', {})], "path: %s" % repr(dsURI.navPath))
        self.assertTrue(
            dsURI.pathOption == PathOption.count, "$count recognised")
        ...
        self.assertTrue(
            isinstance(dsURI.navPath[0][1][u''], edm.Int32Value), "Key value type")
        ...
        self.assertTrue(
            dsURI.pathOption == PathOption.value, "$value recognised")
        dsURI = ODataURI('Products(x=1,y=2)', '/x.svc')
        self.assertTrue(len(dsURI.navPath) == 1)
        self.assertTrue(dsURI.navPath[0][0] == u'Products')
        self.assertTrue(
            isinstance(dsURI.navPath[0][1][u'x'], edm.Int32Value), "Key value type")
        self.assertTrue(dsURI.navPath[0][1][u'x'].value == 1, "x Key value")
        self.assertTrue(
            isinstance(dsURI.navPath[0][1][u'y'], edm.Int32Value), "Key value type")
    ...
    def testCaseExpand(self):
        ...
        self.assertTrue(expand['OrderLines'] == {
                        'Product': None}, "OrderLines expansion: %s" % str(expand))
    ...
    def testCaseFilter(self):
        ...
        self.assertTrue(
            isinstance(filter, BinaryExpression), "Binary expression component")
        self.assertTrue(isinstance(filter.operands[0], PropertyExpression))
        self.assertTrue(filter.operands[0].name == "ShipCountry")
        dsURI = ODataURI(
            "Orders?$filter%20=%20Customers/ContactName%20ne%20'Fred'", '/x.svc')
        filter = dsURI.sysQueryOptions[SystemQueryOption.filter]
    ...
    def testCaseFormat(self):
        ...
        self.assertTrue(
            isinstance(format, http.AcceptList), "Format is an HTTP AcceptList instance")
    ...
    def testCaseOrderby(self):
        ...
        self.assertTrue(
            isinstance(orderBy[0], PropertyExpression), "OrderBy is a property expression")
        self.assertTrue(orderBy[0].name == 'ShipCountry', str(orderBy[0]))
        dsURI = ODataURI(
            "Orders?$orderby%20=%20ShipCountry%20ne%20'France'%20desc", '/x.svc')
        orderBy = dsURI.sysQueryOptions[SystemQueryOption.orderby]
        orderBy = orderBy[0]
        self.assertTrue(orderBy[1] == -1, "desc")
        self.assertTrue(
            isinstance(orderBy[0], BinaryExpression), "OrderBy is a binary expression")
        self.assertTrue(
            orderBy[0].operands[0].name == 'ShipCountry', str(orderBy[0].operands[0]))
        self.assertTrue(
            orderBy[0].operands[0].name == 'ShipCountry', str(orderBy[0].operands[0]))
        dsURI = ODataURI(
            "Orders?$orderby%20=%20ShipCountry%20ne%20'France'%20desc,OrderID%20asc", '/x.svc')
        orderBy = dsURI.sysQueryOptions[SystemQueryOption.orderby]
    ...
    def testCaseInlineCount(self):
        ...
        dsURI = ODataURI(
            "Orders?$inlinecount=allpages&$filter=ShipCountry%20eq%20'France'", '/x.svc')
        inlineCount = dsURI.sysQueryOptions[SystemQueryOption.inlinecount]
        self.assertTrue(
            inlineCount == InlineCount.allpages, "allpages constant")
    ...
    def testCaseSelect(self):
        ...
        self.assertTrue(
            select == {'CompanyName': None, 'CustomerID': None, 'Address': None})
        dsURI = ODataURI("Customers?$select=CustomerID,Orders", '/x.svc')
        select = dsURI.sysQueryOptions[SystemQueryOption.select]
        self.assertTrue(select == {'CustomerID': None, 'Orders': None})
        dsURI = ODataURI(
            "Customers?$select=CustomerID,Orders&$expand=Orders/OrderDetails", '/x.svc')
        select = dsURI.sysQueryOptions[SystemQueryOption.select]
        self.assertTrue(select == {'CustomerID': None, 'Orders': None})
...
class DataServiceRegressionTests(unittest.TestCase):
    ...
    def RunTestCaseAllTypes(self):
        ...
        with allTypes.OpenCollection() as collection:
            ...
            #	READ (collection)
            self.assertTrue(
                len(collection) == 1, "AllTypes length after insert")
            ...
            self.assertTrue(
                gotEntity['BinaryFixed'].value == '1234567890', "BinaryFixed on read")
            self.assertTrue(
                gotEntity['BinaryVariable'].value == '1234567', "BinaryVariable on read")
            self.assertTrue(
                gotEntity['BooleanProperty'].value == True, "BooleanProperty on read")
            self.assertTrue(isinstance(gotEntity[
                            'DateTimeProperty'].value, iso.TimePoint), "DateTimeProperty type on read")
            self.assertTrue(gotEntity['DateTimeProperty'].value == iso.TimePoint.FromString(
                '1972-03-03T09:45:00'), "DateTimeProperty value on read")
            self.assertTrue(isinstance(
                gotEntity['TimeProperty'].value, iso.Time), "TimeProperty type on read")
            self.assertTrue(gotEntity['TimeProperty'].value == iso.Time.FromString(
                '09:45:00'), "TimeProperty value on read")
            self.assertTrue(isinstance(gotEntity[
                            'DateTimeOffsetProperty'].value, iso.TimePoint), "DateTimeOffsetProperty type on read")
            self.assertTrue(gotEntity['DateTimeOffsetProperty'].value == iso.TimePoint.FromString(
                '1972-07-03T09:45:00+01:00'), "DateTimeOffsetProperty value on read")
            self.assertTrue(isinstance(gotEntity[
                            'DecimalProperty'].value, decimal.Decimal), "DecimalProperty type on read")
            self.assertTrue(gotEntity['DecimalProperty'].value == decimal.Decimal(
                '3.14'), "DecimalProperty value on read")
            self.assertTrue(
                gotEntity['SingleValue'].value == 3.14, "SingleValue on read")
            self.assertTrue(
                gotEntity['DoubleValue'].value == 3.14, "DoubleValue on read")
            self.assertTrue(
                isinstance(gotEntity['GuidValue'].value, uuid.UUID), "GuidValue type on read")
            self.assertTrue(
                gotEntity['GuidValue'].value == uuid.UUID(int=3), "GuidValue value on read")
            self.assertTrue(
                gotEntity['SByteValue'].value == 3, "SByteValue on read")
            self.assertTrue(
                gotEntity['Int16Value'].value == 3, "Int16Value on read")
            self.assertTrue(
                gotEntity['Int64Value'].value == 3, "Int64Value on read")
            self.assertTrue(
                gotEntity['ByteValue'].value == 3, "ByteValue on read")
            self.assertTrue(
                gotEntity['UnicodeString'].value == u"Caf\xe9", "UnicodeString on read")
            self.assertTrue(
                gotEntity['ASCIIString'].value == u"Cafe", "ASCIIString on read")
            self.assertTrue(
                gotEntity['FixedString'].value == u"ALFKI", "FixedString on read")
            #	UPDATE
            gotEntity['BinaryFixed'].SetFromValue(
            ...
            gotEntity['FixedString'].SetFromValue(
                u"\u2780\u2781\u2782\u2783\u2784")
            collection.update_entity(gotEntity)
            checkEntity = collection[1]
            self.assertTrue(checkEntity[
                            'BinaryFixed'].value == '\x00\x01\x02\x03\x04~\xDE\xAD\xBE\xEF', "BinaryFixed on read")
            self.assertTrue(checkEntity[
                            'BinaryVariable'].value == '\x00~\xDE\xAD\xBE\xEF', "BinaryVariable on read")
            self.assertTrue(
                checkEntity['BooleanProperty'].value == False, "BooleanProperty on read")
            self.assertTrue(isinstance(checkEntity[
                            'DateTimeProperty'].value, iso.TimePoint), "DateTimeProperty type on read")
            self.assertTrue(checkEntity['DateTimeProperty'].value == iso.TimePoint.FromString(
                '2013-12-25T15:59:03.142'), "DateTimeProperty value on read")
            self.assertTrue(isinstance(
                checkEntity['TimeProperty'].value, iso.Time), "TimeProperty type on read")
            self.assertTrue(checkEntity['TimeProperty'].value.GetString(
                ndp=3, dp=".") == '17:32:03.142', "TimeProperty value on read")
            self.assertTrue(isinstance(checkEntity[
                            'DateTimeOffsetProperty'].value, iso.TimePoint), "DateTimeOffsetProperty type on read")
            self.assertTrue(checkEntity['DateTimeOffsetProperty'].value.GetCalendarString(
                ndp=3, dp=".") == '2013-12-25T15:59:03.142-05:00', "DateTimeOffsetProperty value on read")
            self.assertTrue(isinstance(checkEntity[
                            'DecimalProperty'].value, decimal.Decimal), "DecimalProperty type on read")
            self.assertTrue(checkEntity['DecimalProperty'].value == decimal.Decimal(
                '-100.50'), "DecimalProperty value on read")
            self.assertTrue(
                checkEntity['SingleValue'].value == -100.5, "SingleValue on read")
            self.assertTrue(
                checkEntity['DoubleValue'].value == -100.5, "DoubleValue on read")
            self.assertTrue(
                isinstance(checkEntity['GuidValue'].value, uuid.UUID), "GuidValue type on read")
            self.assertTrue(checkEntity['GuidValue'].value == uuid.UUID(
                int=20131225155903142), "GuidValue value on read")
            self.assertTrue(
                checkEntity['SByteValue'].value == -101, "SByteValue on read")
            self.assertTrue(
                checkEntity['Int16Value'].value == -101, "Int16Value on read")
            self.assertTrue(
                checkEntity['Int64Value'].value == -101, "Int64Value on read")
            self.assertTrue(
                checkEntity['ByteValue'].value == 255, "ByteValue on read")
            self.assertTrue(
                checkEntity['UnicodeString'].value == u"I\u2764Unicode", "UnicodeString on read")
            self.assertTrue(
                checkEntity['ASCIIString'].value == u"Bistro", "ASCIIString on read")
            self.assertTrue(checkEntity[
                            'FixedString'].value == u"\u2780\u2781\u2782\u2783\u2784", "FixedString on read")
            #	DELETE
            del collection[1]
            self.assertTrue(
                len(collection) == 0, "AllTypes length after DELETE")
            try:
                gotEntity = collection[1]
    ...
    def RunTestCaseComplexTypes(self):
        ...
        with complexTypes.OpenCollection() as collection:
            ...
            #	READ (collection)
            self.assertTrue(
                len(collection) == 1, "ComplexTypes length after insert")
            gotEntity = collection.values()[0]
            ...
            self.assertTrue(
                gotEntity['Complex']['Data'].value == 'Level1', "Level 1 on read")
            self.assertTrue(
                gotEntity['Complex']['Complex']['Data'].value == 'Level2', "Level 2 on read")
            self.assertTrue(
                gotEntity['Complex']['Complex']['Index'].value == 255, "Level 2 index on read")
            #	UPDATE
            gotEntity['Complex']['Data'].SetFromValue("Level1Update")
            gotEntity['Complex']['Complex'][
                'Data'].SetFromValue("Level2Update")
            gotEntity['Complex']['Complex']['Index'].SetFromValue(-255)
            collection.update_entity(gotEntity)
            checkEntity = collection[100]
            self.assertTrue(
                gotEntity['Complex']['Data'].value == 'Level1Update', "Level 1 on read")
            self.assertTrue(gotEntity['Complex']['Complex'][
                            'Data'].value == 'Level2Update', "Level 2 on read")
            self.assertTrue(
                gotEntity['Complex']['Complex']['Index'].value == -255, "Level 2 index on read")
            #	DELETE
            del collection[100]
            self.assertTrue(
                len(collection) == 0, "ComplexTypes length after DELETE")
            try:
                gotEntity = collection[100]
    ...
    def RunTestCaseCompoundKey(self):
        ...
        with compoundKeys.OpenCollection() as collection:
            ...
            #	READ (collection)
            self.assertTrue(
                len(collection) == 1, "CompoundKey length after insert")
            gotEntity = collection.values()[0]
            self.assertTrue(gotEntity['K1'].value == 1)
            self.assertTrue(gotEntity['K2'].value == '00001')
            self.assertTrue(gotEntity['K3'].value.GetCalendarString(
            ...
            #	READ (by key)
            gotEntity = collection[(1, '00001', iso.TimePoint.FromString(
                '2013-12-25T15:59:03.142'), '\xde\xad\xbe\xef')]
            self.assertTrue(gotEntity['Data'].value == "Compound Key")
            #	UPDATE
            gotEntity['Data'].SetFromValue("Updated Compound Key")
            collection.update_entity(gotEntity)
            checkEntity = collection[(1, '00001', iso.TimePoint.FromString(
                '2013-12-25T15:59:03.142'), '\xde\xad\xbe\xef')]
            self.assertTrue(
                checkEntity['Data'].value == 'Updated Compound Key')
            #	DELETE
            del collection[(1, '00001', iso.TimePoint.FromString(
                '2013-12-25T15:59:03.142'), '\xde\xad\xbe\xef')]
            self.assertTrue(
                len(collection) == 0, "CompoundKey length after DELETE")
            try:
                gotEntity = collection[(1, '00001', iso.TimePoint.FromString(
                    '2013-12-25T15:59:03.142'), '\xde\xad\xbe\xef')]
    ...
    def RunTestCasePaging(self):
        ...
        with pagingSet.OpenCollection() as collection:
            ...
            self.assertTrue(
                collection.next_skiptoken() is None, "10,2: skiptoken")
            ...
            try:
                ...
                self.assertTrue(
                    result[4].Key() == (0, 4), "max 5: last entity on first page")
                ...
                for i in xrange(4):
                    ...
                    self.assertTrue(result[0].Key() == (
                        (i * 5) // 10, (i * 5) % 10), "max 5: first entity on page")
                collection.set_page(top=10, skip=None, skiptoken=token)
                # This should wind us back to page 2
                result = list(collection.iterpage())
                self.assertTrue(len(result) == 5, "max 5: length")
                self.assertTrue(
                    result[4].Key() == (0, 9), "max 5: last entity on page 2")
                # now add an ordering
                collection.set_orderby(
                    CommonExpression.OrderByFromString(u"Sum desc"))
                # must have rest the skiptoken
                self.assertTrue(
                    collection.next_skiptoken() is None, "No page set")
                collection.set_page(top=10)
                result = list(collection.iterpage(set_next=True))
                self.assertTrue(
                    result[0].Key() == (9, 9), "first page with ordering")
                self.assertTrue(
                    result[1].Key() == (8, 9), "first page with ordering (8,9)")
                self.assertTrue(
                    result[2].Key() == (9, 8), "first page with ordering (9,8)")
                token = collection.next_skiptoken()
                self.assertTrue(token is not None, "skip token present")
                result = list(collection.iterpage(set_next=True))
                self.assertTrue(
                    result[0].Key() == (9, 7), "second page with ordering (9,7)")
                self.assertTrue(
                    result[1].Key() == (6, 9), "second page with ordering (9,8)")
                for i in xrange(18):
                    logging.info("$skiptoken=%s", collection.next_skiptoken())
                    result = list(collection.iterpage(set_next=True))
                self.assertTrue(
                    result[2].Key() == (0, 1), "last page with ordering (0,1)")
                self.assertTrue(
                    result[3].Key() == (1, 0), "last page with ordering (1,0)")
                self.assertTrue(
                    result[4].Key() == (0, 0), "last page with ordering (0,0)")
    ...
    def RunTestCaseNavigationOne2One(self):
        ...
        with ones.OpenCollection() as collection, onexs.OpenCollection() as collectionX:
            ...
            self.assertTrue(
                navX is not None, "Failed to read back navigation link")
            ...
            try:
                ...
                self.fail(
                    "Nav collection __setitem__ should have failed for 1-1 relationship")
            except edm.ConstraintError:
                pass
            ...
            try:
                entity.Update()
                self.fail(
                    "BindEntity/Update should have failed for 1-1 relationship")
            except edm.ConstraintError:
                pass
            #	DELETE - link
            with entity['OX'].OpenCollection() as navCollection:
                try:
                    ...
                    pass
            # DELETE - entity; for a 1-1 link it should fail or cascade the
            # delete
            try:
                del collection[1]
                self.assertFalse(
                    1 in collection, "Delete with a 1-1 relationship")
                self.assertFalse(
                    100 in collectionX, "Cascade delete for 1-1 relationship")
            except edm.ConstraintError:
    ...
    def RunTestCaseNavigationOne2One1(self):
        ...
        with ones.OpenCollection() as collection, onexs.OpenCollection() as collectionX:
            ...
            try:
                collectionX.insert_entity(e2X)
                self.fail(
                    "Entity insert should fail with unbound 1-1 relationship")
            except edm.ConstraintError:
                pass
    ...
    def RunTestCaseNavigationZeroOne2One(self):
        ...
        with zeroones.OpenCollection() as collectionZO, ones.OpenCollection() as collectionO:
            ...
            try:
                ...
                self.fail(
                    "Unbound entity insert failed at the 1 end of 0..1-1 link")
            # entityZO <-> entityO
            # entityZO2 <-> entityO2
            # None <-> entityO3
            ...
            with entityZO['O'].OpenCollection() as navCollection:
                ...
                try:
                    ...
                    self.fail(
                        "insert_entity on navigation collection should fail towards the 1 end")
                except edm.ConstraintError:
                    pass
            ...
            try:
                ...
                logging.warn(
                    "Non-transactional behaviour detected after failed insert on 0..1 to 1 navigation collection")
            ...
            with entityO3['ZO'].OpenCollection() as navCollection:
                ...
                try:
                    ...
                    self.fail(
                        "insert_entity on navigation collection should not fail towards the 0..1 end")
            # entityZO <-> entityO
            # entityZO2 <-> entityO2
            # entityZO3 <-> entityO3
            # None <-> entityO4
            ...
            self.assertTrue(
                navO is not None, "Failed to read back navigation link")
            self.assertTrue(navO['K'] == 100)
            navZO = navO['ZO'].GetEntity()
            self.assertFalse(
                navZO is None, "Failed to read back reverse navigation link")
            ...
            try:
                entityO2.Update()
                self.fail(
                    "BindEntity/Update on 1-0..1 navigation property should fail")
            except edm.ConstraintError:
                pass
            #	DELETE - link
            ...
            with entityZO['O'].OpenCollection() as navCollection:
                try:
                    ...
                    del navCollection[100]
                    self.fail(
                        "Delete of link in a 0..1-1 relationship from the 0..1 end")
                except edm.ConstraintError:
                    pass
            ...
            try:
                del collectionZO[1]
                self.assertFalse(
                    1 in collectionZO, "Delete entity at 0..1 end of relationship")
                self.assertTrue(
                    100 in collectionO, "No cascade delete expected for 0..1-1 relationship")
            except edm.ConstraintError:
            ...
            # entityZO3 <-> entityO3
            # None <-> entityO4
            # DELETE - entity; for a 0..1-1 link should fail or cascade the
            # delete on the 1 end
            try:
                del collectionO[200]
                self.assertFalse(
                    200 in collectionO, "Delete entity at 1 end of relationship")
                self.assertFalse(
                    2 in collectionZO, "Cascade delete required for 0..1 end of relationship")
            except edm.ConstraintError:
                # an error is acceptable here, though we generate a warning
    ...
    def RunTestCaseNavigationZeroOne2OneForward(self):
        ...
        with zeroones.OpenCollection() as collectionZO, ones.OpenCollection() as collectionO:
            ...
            try:
                del collectionO[200]
                self.fail(
                    "(Cascade) delete not allowed over unbound navigation property")
            except edm.ConstraintError:
                self.assertTrue(200 in collectionO)
                self.assertTrue(2 in collectionZO)
    ...
    def RunTestCaseNavigationZeroOne2OneReverse(self):
        ...
        with zeroones.OpenCollection() as collectionZO, ones.OpenCollection() as collectionO:
            ...
            try:
                collectionZO.insert_entity(entityZO)
                self.fail(
                    "Entity inserted without 0..1-1 relationship (unbound navigation property)")
            except edm.ConstraintError:
                pass
            entityO = collectionO.new_entity()
            entityO['K'].SetFromValue(100)
            ...
            navZO = entityO['ZO'].GetEntity()
            self.assertTrue(
                navZO is not None, "Failed to read back navigation link")
            self.assertTrue(navZO['K'] == 1)
            # UPDATE - by inserting a new value into the navigation collection
            # should work
            entityZO2 = collectionZO.new_entity()
            entityZO2['K'].SetFromValue(2)
            ...
            with entityO2['ZO'].OpenCollection() as navCollection:
                try:
                    ...
                    logging.warning(
                        "Insertion into O[2].ZO not supported due to absence of back-link")
                except edm.ConstraintError:
                    self.fail(
                        "Failed to insert a new entity at the 0..1 end of an empty link")
            ...
            try:
                ...
                self.assertTrue(
                    100 in collectionO, "No cascade delete expected for 0..1-1 relationship")
                self.assertTrue(entityO['ZO'].GetEntity(
                ) is None, "Link should have been broken by deletion at 0..1 end")
            except edm.ConstraintError:
                self.fail("Delete entity failed at 0..1 end of relationship")
    ...
    def RunTestCaseNavigationMany2One(self):
        ...
        with manys.OpenCollection() as collectionMany, ones.OpenCollection() as collectionO:
            ...
            try:
                ...
                self.fail(
                    "Unbound entity insert failed at the 1 end of *-1 link")
            # [] <-> entityO3
            #	READ both ways
            ...
            try:
                ...
                self.fail(
                    "GetEntity should fail on a deferred value with multiplicity *")
            ...
            try:
                ...
                self.assertFalse(
                    1 in collectionMany, "Delete entity at * end of relationship")
                self.assertTrue(
                    100 in collectionO, "No cascade delete expected for *-1 relationship")
            except edm.ConstraintError:
            ...
            try:
                ...
                self.assertFalse(
                    200 in collectionO, "Delete entity at 1 end of relationship")
                self.assertFalse(
                    2 in collectionMany, "Cascade delete required for * end of relationship")
                self.assertFalse(
                    3 in collectionMany, "Cascade delete required for * end of relationship")
            except edm.ConstraintError:
                # an error is acceptable here, though we generate a warning
    ...
    def RunTestCaseNavigationMany2OneForward(self):
        ...
        with manys.OpenCollection() as collectionMany, ones.OpenCollection() as collectionO:
            ...
            try:
                ...
                self.assertFalse(
                    3 in collectionMany, "Delete entity at * end of relationship")
                self.assertTrue(
                    200 in collectionO, "No cascade delete expected for *-1 relationship")
            except edm.ConstraintError:
                self.fail("Delete entity failed at * end of relationship")
            #	DELETE - entity; for a *-1 link should fail or cascade the delete on the 1 end
            # entityMany, entityMany2 <-> entityO
            ...
            try:
                ...
                self.fail(
                    "Cascale delete across *-1 relationship (unbound back link)")
            except edm.ConstraintError:
    ...
    def RunTestCaseNavigationMany2OneReverse(self):
        ...
        with manys.OpenCollection() as collectionMany, ones.OpenCollection() as collectionO:
            ...
            try:
                collectionMany.insert_entity(entityMany)
                self.fail(
                    "Entity inserted without *-1 relationship (no forward link)")
            except edm.ConstraintError:
                pass
            entityO = collectionO.new_entity()
            entityO['K'].SetFromValue(100)
            ...
            try:
                ...
                self.assertFalse(
                    3 in collectionMany, "Cascade delete required for * end of relationship")
                self.assertFalse(
                    4 in collectionMany, "Cascade delete required for * end of relationship")
            except edm.ConstraintError:
                # an error is acceptable here, though we generate a warning
                logging.warning("no cascade delete across *-1 relationship")
                self.assertTrue(200 in collectionO)
    ...
    def RunTestCaseNavigationMany2ZeroOne(self):
        ...
        with manys.OpenCollection() as collectionMany, zeroones.OpenCollection() as collectionZO:
            ...
            try:
                entityZO2.Update()
                self.fail(
                    "BindEntity/Update on 0..1-* navigation property should fail")
            except edm.ConstraintError:
                pass
            #	DELETE - link
            # entityMany <-> None
            ...
            with entityZO['Many'].OpenCollection() as navCollection:
                try:
                    ...
                    self.assertTrue(2 in collectionMany)
                    self.assertTrue(
                        collectionMany[2]['ZO'].GetEntity() == None)
                except edm.ConstraintError:
                    self.fail(
            ...
            with entityMany3['ZO'].OpenCollection() as navCollection:
                try:
                    ...
                    self.fail(
                        "Delete of link in a *-0..1 relationship from the * end")
            ...
            try:
                ...
                self.assertFalse(
                    4 in collectionMany, "Delete entity at * end of relationship")
                self.assertTrue(
                    200 in collectionZO, "No cascade delete expected for *-0..1 relationship")
            except edm.ConstraintError:
                self.fail("Delete entity failed at * end of relationship")
            ...
            try:
                ...
                self.assertFalse(
                    100 in collectionZO, "Delete entity at 0..1 end of relationship")
                self.assertTrue(
                    1 in collectionMany, "Cascade delete not allowed for * end of relationship")
                self.assertTrue(
                    2 in collectionMany, "Cascade delete not allwoed for * end of relationship")
            except edm.ConstraintError:
        ...
        with manys.OpenCollection() as collectionMany, zeroones.OpenCollection() as collectionZO:
            ...
            with entityZO['Many'].OpenCollection() as navCollection:
                try:
                    ...
                    self.fail(
                        "__setitem__ on 0..1-* navigation property should succeed")
                try:
                    navCollection[entityMany2.Key()] = entityMany2
                    self.fail(
                        "__setitem__ on 0..1-* navigation property should fail (target already linked)")
                except edm.ConstraintError:
                    pass
            #	UPDATE - using bind and update
            # entityMany <-> entityZO
            ...
            try:
                ...
                self.assertFalse(
                    1 in collectionMany, "Delete entity at * end of relationship")
                self.assertTrue(
                    100 in collectionZO, "No cascade delete expected for *-0..1 relationship")
            except edm.ConstraintError:
                self.fail("Delete entity failed at * end of relationship")
            #	DELETE - entity; for a *-0..1 link should succeed on the 0..1 end
            # None <-> entityZO
            ...
            try:
                ...
                self.assertFalse(
                    200 in collectionZO, "Delete entity at 0..1 end of relationship")
                self.assertTrue(
                    2 in collectionMany, "Cascade delete not allowed for * end of relationship")
                self.assertTrue(
                    3 in collectionMany, "Cascade delete not allwoed for * end of relationship")
            except edm.ConstraintError:
                self.fail("Delete entity at the 0..1 end of the relationship")
            # None <-> entityZO
            # entityMany2 <-> None
    ...
    def RunTestCaseNavigationMany2ZeroOneRecursive(self):
        ...
        with manys2zeroones.OpenCollection() as collection:
            ...
            try:
                del collection[3]
                self.assertFalse(
                    3 in collection, "Delete entity at * end of relationship")
                self.assertTrue(
                    4 in collection, "No cascade delete expected for *-0..1 relationship")
            except edm.ConstraintError:
                self.fail("Delete entity failed at * end of relationship")
            #	DELETE - entity; for a *-0..1 link should succeed on the 0..1 end
            # [] <-> entity1 <-> None
            ...
            try:
                del collection[4]
                self.assertFalse(
                    4 in collection, "Delete entity at 0..1 end of relationship")
                self.assertTrue(
                    5 in collection, "Cascade delete not allowed for * end of relationship")
                self.assertTrue(
                    2 in collection, "Cascade delete not allwoed for * end of relationship")
            except edm.ConstraintError:
                self.fail("Delete entity at the 0..1 end of the relationship")
            # [] <-> entity1 <-> None
            # [] <-> entity5 <-> None
    ...
    def RunTestCaseNavigationMany2Many(self):
        ...
        with manys.OpenCollection() as collectionMany, manyXs.OpenCollection() as collectionManyX:
            ...
            # entityMany, entityMany2, entityMany3, entityMany4 <->
            # entityManyX2
            ...
            try:
                del collectionMany[4]
                self.assertFalse(
                    4 in collectionMany, "Delete entity in *-* relationship")
                self.assertTrue(
                    200 in collectionManyX, "No cascade delete expected for *-* relationship")
            except edm.ConstraintError:
            ...
            try:
                ...
                self.assertFalse(
                    200 in collectionManyX, "Delete entity in *-* relationship")
                self.assertTrue(
                    1 in collectionMany, "Cascade delete not allowed for * end of relationship")
                self.assertTrue(
                    2 in collectionMany, "Cascade delete not allwoed for * end of relationship")
        ...
        with manys.OpenCollection() as collectionMany, manyXs.OpenCollection() as collectionManyX:
            ...
            try:
                ...
                self.assertFalse(
                    200 in collectionManyX, "Delete entity in *-* relationship")
                self.assertTrue(
                    1 in collectionMany, "No cascade delete expected for *-* relationship")
                self.assertTrue(
                    2 in collectionMany, "No cascade delete expected for *-* relationship")
                self.assertTrue(
                    3 in collectionMany, "No cascade delete expected for *-* relationship")
            except edm.ConstraintError:
            ...
            try:
                del collectionMany[1]
                self.assertFalse(
                    1 in collectionMany, "Delete entity in *-* relationship")
                self.assertTrue(
                    100 in collectionManyX, "Cascade delete not allowed for * end of relationship")
                self.assertTrue(
                    300 in collectionManyX, "Cascade delete not allwoed for * end of relationship")
            except edm.ConstraintError:
                self.fail("Delete entity for *-* relationship")
            # entityMany2  -> []
            # entityMany3  -> entityManyX3
    ...
    def RunTestCaseNavigationMany2ManyRecursive(self):
        ...
        with manys2manys.OpenCollection() as collection:
            ...
            try:
                del collection[3]
                self.assertFalse(
                    3 in collection, "Delete entity in * relationship")
                self.assertTrue(
                    4 in collection, "No cascade delete expected for *-* relationship")
            except edm.ConstraintError:
            ...
            try:
                del collection[5]
                self.assertFalse(
                    5 in collection, "Delete entity in * relationship")
                self.assertTrue(
                    4 in collection, "Cascade delete not allowed in * end of relationship")
                self.assertTrue(
                    2 in collection, "Cascade delete not allowed in * end of relationship")
                self.assertTrue(
                    1 in collection, "Cascade delete not allwoed in * end of relationship")
            except edm.ConstraintError:
        ...
        with manys2manys.OpenCollection() as collection:
            ...
            try:
                ...
                self.assertFalse(
                    3 in collection, "Delete entity in * relationship")
                self.assertTrue(
                    2 in collection, "No cascade delete expected for *-* relationship")
            except edm.ConstraintError:
                self.fail("Delete entity failed in * relationship")
            # entity4 <- entity1 -> []
            # entity4 <- entity2 -> []
            ...
            try:
                del collection[4]
                self.assertFalse(
                    4 in collection, "Delete entity in * relationship")
                self.assertTrue(
                    2 in collection, "Cascade delete not allowed in * end of relationship")
                self.assertTrue(
                    1 in collection, "Cascade delete not allwoed in * end of relationship")
