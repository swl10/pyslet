...
class XMLParserTests(unittest.TestCase):
    ...
    def testCaseName(self):
        ...
        for s in sBad:
            ...
            try:
                name = p.ParseName()
                self.assertFalse(
                    p.the_char is None, "ParseName negative test: %s" % s)
            except XMLWellFormedError:
                pass
        e = XMLEntity('&noname')
        p = XMLParser(e)
    ...
    def testCaseNmtoken(self):
        ...
        for s in sBad:
            ...
            try:
                name = p.ParseNmtoken()
                self.assertFalse(
                    p.the_char is None, "ParseNmtoken negative test: %s" % s)
            except XMLWellFormedError:
                pass
    ...
    def testNotationType(self):
        ...
        p = XMLParser(e)
        for match in m:
            value = p.ParseNotationType(p.the_char != 'N')
            self.assertTrue(
