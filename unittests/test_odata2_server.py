...
class MockODataServer:
    ...
    def __init__(self):
        self.state = 0
        self.dataRoot = FilePath(
            FilePath(__file__).abspath().split()[0], 'data_odatav2', 'mock_server')
...
class ODataURILiteralTests(unittest.TestCase):
    ...
    def testCaseBinaryLiteral(self):
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Binary, "binary type: %s" % repr(v.typeCode))
    ...
    def testCaseBooleanLiteral(self):
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Boolean, "boolean type: %s" % repr(v.typeCode))
    ...
    def testCaseDateTimeLiteral(self):
        ...
        self.assertTrue(v.typeCode == edm.SimpleType.DateTime,
                        "date time type for leap second: %s" % repr(v.typeCode))
        ...
        self.assertTrue(v.typeCode == edm.SimpleType.DateTime,
                        "date time extreme: %s" % repr(v.typeCode))
        self.assertTrue(
            str(v.value) == "2012-06-30T24:00:00", "date time extreme: %s" % str(v.value))
    ...
    def testCaseDecimalLiteral(self):
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Decimal, "0M type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Decimal, "1.1m type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Decimal, "29-digit type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(v2.value - v.value < 0.13 and v2.value - v.value >
                        0.12, "29digit.29digit value: %s" % repr(v2.value - v.value))
        v = core.ParseURILiteral("-2147483648M")
        self.assertTrue(v.typeCode == edm.SimpleType.Decimal,
                        "-2147483648 type: %s" % repr(v.typeCode))
        self.assertTrue(
            v.value == -2147483648, "-2147483648 value: %s" % repr(v.value))
    ...
    def testCaseDoubleLiteral(self):
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Double, "0D type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Double, "1.1d type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Double, "17-digit type: %s" % repr(v.typeCode))
        self.assertTrue(round(math.log10(v.value), 3) ==
                        16.092, "29-digit log10 value: %s" % repr(v.value))
        v = core.ParseURILiteral("-12345678901234567D")
        self.assertTrue(v.typeCode == edm.SimpleType.Double,
                        "17-digit negative type: %s" % repr(v.typeCode))
        self.assertTrue(round(math.log10(-v.value), 3) ==
                        16.092, "29-digit log10 value: %s" % repr(v.value))
        v = core.ParseURILiteral(
            "123456789012345678901234567890.123456789012345678901234567890D")
        self.assertTrue(v.typeCode == edm.SimpleType.Double,
                        "30digit.30digit type: %s" % repr(v.typeCode))
        self.assertTrue(round(math.log10(v.value), 3) ==
    ...
    def testCaseSingleLiteral(self):
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Single, "0f type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Single, "1.1f type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Single, "8-digit type: %s" % repr(v.typeCode))
        self.assertTrue(v.value == 12345678, "8-digit: %s" % repr(v.value))
        v = core.ParseURILiteral("-12345678F")
        self.assertTrue(v.typeCode == edm.SimpleType.Single,
                        "8-digit negative type: %s" % repr(v.typeCode))
        self.assertTrue(
    ...
    def testCaseGuidLiteral(self):
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Guid, "guide type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(
            isinstance(v.value, uuid.UUID), "guide type: %s" % repr(v.value))
        self.assertTrue(v.value.hex.lower(
        ) == 'cd04f705390c473698dca3baa6b3a283', "guid value (random): %s" % repr(v.value))
        for bad in [
    ...
    def testCaseInt64Literal(self):
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Int64, "0L type: %s" % repr(v.typeCode))
        self.assertTrue(
        ...
        self.assertTrue(
            v.typeCode == edm.SimpleType.Int64, "19-digit type: %s" % repr(v.typeCode))
        self.assertTrue(
            v.value == 1234567890123456789L, "19-digit value: %s" % repr(v.value))
        v = core.ParseURILiteral("-1234567890123456789l")
        self.assertTrue(
            v.typeCode == edm.SimpleType.Int64, "19-digit neg type: %s" % repr(v.typeCode))
        self.assertTrue(
            v.value == -1234567890123456789L, "19-digit neg value: %s" % repr(v.value))
...
# 				pass
    ...
    def testCaseDateTimeOffsetLiteral(self):
        ...
        self.assertTrue(v.typeCode == edm.SimpleType.DateTimeOffset,
                        "date time offset type: %s" % repr(v.typeCode))
        self.assertTrue(
            isinstance(v.value, iso.TimePoint), "value type: %s" % repr(v.value))
        self.assertTrue(
            isinstance(v.value, iso.TimePoint), "value type: %s" % repr(v.value))
...
class ServerTests(unittest.TestCase):
    ...
    def testCaseConstructor(self):
        ...
        self.assertTrue(
            isinstance(s.serviceRoot, uri.URI), "Service root not a URI")
        # feed=s.GetFeed('Test')
    ...
    def testCaseCapability(self):
        ...
        self.assertTrue(request.responseHeaders[
                        'CONTENT-TYPE'] == "application/json", "Expected JSON response")
        ...
        self.assertTrue(
            errorDoc['error']['code'] == "DataServiceVersionMismatch", "Error code")
        self.assertTrue(errorDoc['error'][
                        'message'] == "Maximum supported protocol version: 2.0", "Error message")
    ...
    def testCaseEntityTypeAsAtomEntry(self):
        ...
        # the <atom:content> element MUST contain a "type" attribute with the
        ...
        for child in children:
            ...
            if child.rel.startswith(core.ODATA_RELATED):
                ...
                self.assertTrue(
                    child.parent is entry, "Link must be a child of the entry element")
                #	The element SHOULD also contain an atom:title attribute
                #	with the value equal to the NavigationProperty name
                self.assertTrue(
                    pName in navigation, "Link must be a navigation property")
                self.assertTrue(
                    child.title == pName, "Title should be name of navigation property")
        ...
        self.assertTrue(
            links['Orders'][1] == "application/atom+xml;type=feed", "Orders link type")
        ...
        for child in children:
            if child.rel.startswith(core.ODATA_RELATED):
                ...
                self.assertTrue(
                    child.title == pName, "Title should be name of navigation property")
                self.assertTrue(
                    child.type is None, "We don't need the child type")
                pName = child.rel[len(core.ODATA_RELATED):]
                self.assertTrue(pName == 'Orders', "Only Orders link is bound")
                if child.href == "Customers('X')/Orders":
                    self.assertTrue(
                        child.Inline is not None, "deep link has child")
                    self.assertTrue(
                        child.Inline.Feed is not None, "deep link child has Feed")
                    # test the collection in the feed
                    self.assertTrue(
                        len(child.Inline.Feed.collection) == 1, "one deep-linked child")
        ...
        for child in children:
            if child.rel.startswith(core.ODATA_RELATED):
                ...
                links[pName] = (child.href, child.type)
        self.assertTrue(
            links['Customer'][0] == "Orders(1)/Customer", "Customer link")
        #	[the atom:type attribute] should have a value of
        #	"application/atom+xml;type=entry" when the
        #	NavigationProperty identifies a single entity instance
        self.assertTrue(
            links['Customer'][1] == "application/atom+xml;type=entry", "Customer link type")
        self.assertTrue(
            links['OrderLine'][0] == "Orders(1)/OrderLine", "OrderLine link")
        self.assertTrue(links['OrderLine'][
                        1] == "application/atom+xml;type=entry", "OrderLine link type")
        #
        #	End of order tests
        #
        ...
        for p in pList:
            self.assertTrue(
                p.ns == core.ODATA_DATASERVICES_NAMESPACE, "Property not in data services namespace")
        pNames = map(lambda x: x.xmlname, pList)
        pNames.sort()
        self.assertTrue(
            pNames == ["Address", "EmployeeID", "Version"], "Property names")
        ...
        self.assertTrue(
            len(pList) == 3, "3/4 properties due to keep in content = False")
        ...
        for cat in entry.Category:
            ...
            if cat.scheme == core.ODATA_SCHEME:
                ...
                # instance
                self.assertTrue(cat.term == "SampleModel.Document",
    ...
    def testCaseEntityTypeAsJSON(self):
        ...
        #	Media Link Entry
        self.assertTrue(
            meta["media_src"] == "Documents(1801)/$value", "media src link")
        self.assertTrue(
            meta["content_type"] == "text/plain", "document content type")
        self.assertTrue(
            meta["edit_media"] == "Documents(1801)/$value", "edit-media link")
    ...
    def testCaseEntityTypeFromJSON(self):
        ...
        self.assertTrue(
            newCustomer['CompanyName'].value == "Megacorp", "Check customer name")
        ...
        self.assertTrue(
            newEmployee['EmployeeName'].value == "Joe Bloggs", "Check employee name")
        ...
        self.assertTrue(
            newDocument['Title'].value == "War and Peace", "Check document name")
        self.assertTrue(
            newDocument['Author'] == "Tolstoy", "Check author name")
        self.assertTrue(
    ...
    def testCaseEntitySetAsAtomFeed(self):
        ...
        feed = core.Feed(None, customer['Orders'].OpenCollection())
    ...
    def testCaseEntitySetAsJSON(self):
        ...
        #	complete set.
        self.assertTrue(
            type(obj["__next"]) == DictType, "next link is json object")
        #	Such a URI SHOULD include a Skip Token System Query Option
        self.assertTrue(
            "$skiptoken" in obj["__next"]["uri"], "next link contains a skiptoken")
        ...
        self.assertTrue(jsonData.index("__count") < jsonData.index(
...
class SampleServerTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        orders.data[2] = (
            2, iso8601.TimePoint.from_str('2013-08-13T10:26:00'))
        orders.data[3] = (
            3, iso8601.TimePoint.from_str('2012-05-29T18:13:00'))
        orders.data[4] = (
            4, iso8601.TimePoint.from_str('2012-05-29T18:13:00'))
        ...
        with memds.EntityCollection(entity_set=documents.entity_set,
            ...
            sinfo = core.StreamInfo(type=http.MediaType.from_str(
    ...
    def testCaseEntityTypeFromAtomEntry(self):
        ...
        self.assertFalse(newCustomer['Version'], "No version")
        self.assertTrue(
            len(newCustomer['Orders'].bindings) == 0, "new customer not bound")
        customer.exists = False
        customer['Orders'].BindEntity(1)
        customer['Orders'].BindEntity(2)
        ...
        self.assertTrue(
            len(newCustomer['Orders'].bindings) == 3, "new customer has 3 orders bound")
        idLinks = set()
        entityLink = None
    ...
    def testCaseServiceRoot(self):
        ...
        self.assertTrue(
            isinstance(doc.root, app.Service), "Service root not an app.Service")
        self.assertTrue(
            len(doc.root.Workspace) == 1, "Sample server has 1 workspace")
        ...
        self.assertTrue(
            request.responseCode == 200, "Service root response: %i" % request.responseCode)
        self.assertTrue(request.responseHeaders[
                        'CONTENT-TYPE'] == 'application/json', "Expected application/json")
    ...
    def testCaseKeyPredicateSingle(self):
        ...
        self.assertTrue(request1.wfile.getvalue() ==
                        request2.wfile.getvalue(), "Mismatched responses with ()")
    ...
    def testCaseURI1(self):
        ...
        self.assertTrue(
            len(doc.root.Entry) == 1, "Sample server has 1 Customer in Chunton")
...
#			self.assertTrue(request.responseCode==400,"UR6 with %s"%x)
    ...
    def testCaseURI7(self):
        ...
        obj = obj["d"]
        self.assertTrue(
            type(obj) == DictType, "Version 2 JSON response is object")
        self.assertTrue("__count" in obj and obj[
                        "__count"] == 2, "Version 2 JSON supports $inlinecount")
        self.assertTrue(
            "results" in obj, "Version 2 JSON response has 'results'")
        self.assertTrue(type(obj["results"]) == ListType, "list of links")
        self.assertTrue(len(
            obj["results"]) == 1, "Sample customer has 2 orders but only 1 returned due to $top")
        ...
        obj = obj["d"]
        self.assertTrue(
            type(obj) == ListType, "Version 1 JSON response is array")
    ...
    def testCaseURI8(self):
        ...
        mType = http.MediaType.from_str(pType.GetAttribute(core.MimeType))
        self.assertTrue(
    ...
    def testCaseURI11(self):
        ...
        obj = obj["d"]
        self.assertTrue(
            type(obj) == ListType, "Expected version 1 JSON output")
    ...
    def testCaseExpand(self):
        ...
        for link in doc.root.FindChildrenDepthFirst(core.Link):
            if link.title == "Customer":
                ...
                if linkInline is not None:
                    linkInline = linkInline.Entry if linkInline.Feed is None else linkInline.Feed
        self.assertTrue(
            isinstance(linkInline, atom.Entry), "Expected atom.Entry in Customer link")
        #	Test json format
        request = MockRequest("/service.svc/Orders(1)?$expand=Customer")
        request.SetHeader('Accept', "application/json")
        request.Send(self.svc)
        ...
        self.assertTrue(
            linkInline is None, "Expected empty inline in Customer link")
        #	Test json format
        request = MockRequest("/service.svc/Orders(4)?$expand=Customer")
        request.SetHeader('Accept', "application/json")
        request.Send(self.svc)
    ...
    def testCaseFilter(self):
        ...
        self.assertTrue(
            len(doc.root.Entry) == 3, "Expected 3 Order after filtering")
    ...
    def testCaseOrderby(self):
        ...
        for e in doc.root.Entry:
            ...
            currTime = iso8601.TimePoint.from_str(e['ShippedDate'].value)
    ...
    def testCaseInsertEntity(self):
        ...
        data = str(doc)
        request.SetHeader('Content-Type', core.ODATA_RELATED_ENTRY_TYPE)
        ...
        self.assertTrue(request.responseHeaders[
                        'LOCATION'] == "http://host/service.svc/Customers('STEVE')")
        self.assertTrue(request.responseHeaders[
                        'CONTENT-TYPE'] == http.MediaType.from_str("application/atom+xml"))
        doc = core.Document()
        doc.Read(request.wfile.getvalue())
        self.assertTrue(isinstance(doc.root, core.Entry),
                        "Expected a single Entry, found %s" % doc.root.__class__.__name__)
        ...
        self.assertTrue(isinstance(doc.root, atom.Feed),
                        "Expected atom.Feed from navigation property Orders")
        self.assertTrue(
            len(doc.root.Entry) == 2, "Inserted customer has 2 orders")
        orderKeys = set()
    ...
    def testCaseInsertEntityJSON(self):
        ...
        self.assertTrue(request.responseHeaders[
                        'LOCATION'] == "http://host/service.svc/Customers('STEVE')")
        self.assertTrue(request.responseHeaders[
                        'CONTENT-TYPE'] == http.MediaType.from_str('application/json'))
        obj = json.loads(request.wfile.getvalue())
        self.assertTrue(type(obj) == DictType and len(
            obj) == 1 and "d" in obj, "JSON object is security wrapped")
        obj = obj["d"]
        self.assertTrue(type(
            obj) == DictType, "Expected a single JSON object, found %s" % repr(type(obj)))
        newCustomer = core.Entity(
            self.ds['SampleModel.SampleEntities.Customers'])
        newCustomer.exists = True
        newCustomer.SetFromJSONObject(obj)
        ...
        obj = obj["d"]
        self.assertTrue(type(
            obj['results']) == ListType, "Expected JSON array from navigation property Orders")
        self.assertTrue(
    ...
    def testCaseInsertMediaResource(self):
        ...
        self.assertTrue(
            location.startswith(u"http://host/service.svc/Documents("))
        self.assertTrue(location[len(
            u"http://host/service.svc/Documents("):-1].isdigit(), "document Id is an integer")
        self.assertTrue(request.responseHeaders[
                        'CONTENT-TYPE'] == http.MediaType.from_str("application/atom+xml"))
        ...
        self.assertTrue(
            newDocument['Title'].value == u"War and Peace", "Slug mapped to syndication title")
        self.assertFalse(
    ...
    def testCaseRetrieveEntitySet(self):
        ...
        self.assertTrue(http.MediaType.from_str(
            request.responseHeaders['CONTENT-TYPE']) == "application/atom+xml")
    ...
    def testCaseRetrievePrimitivePropertyJSON(self):
        ...
        obj = obj["results"]
        self.assertTrue(
            "CompanyName" in obj, "Expected named object 'CompanyName' in response")
    ...
    def testCaseRetrieveValue(self):
        ...
        self.assertTrue(request.responseHeaders['DATASERVICEVERSION'].startswith(
            "2.0;"), "DataServiceVersion 2.0 expected")
        self.assertTrue(http.MediaRange.from_str(
            "text/plain").MatchMediaType(http.MediaType.from_str(request.responseHeaders['CONTENT-TYPE'])))
        # Customer does have a version field for optimistic concurrency control
        self.assertTrue("ETAG" in request.responseHeaders, "Entity set ETag")
        self.assertTrue(
            request.wfile.getvalue() == 'Example Inc', "Bad company")
        ...
        self.assertTrue(request.responseHeaders['DATASERVICEVERSION'].startswith(
            "2.0;"), "DataServiceVersion 2.0 expected")
        self.assertTrue(http.MediaType.from_str(
            request.responseHeaders['CONTENT-TYPE']) == "application/octet-stream")
        # Customer does have a version field for optimistic concurrency control
        self.assertTrue("ETAG" in request.responseHeaders, "Entity set ETag")
        self.assertTrue(
            request.wfile.getvalue() == '\x00\x00\x00\x00\x00\x00\xfa\x01', "Bad version")
    ...
    def testCaseRetrieveServiceDocumentJSON(self):
        ...
        self.assertTrue(type(
            obj) == DictType, "Expected a single JSON object, found %s" % repr(type(obj)))
        self.assertTrue(
            "EntitySets" in obj, "EntitySets in service document response")
        self.assertTrue(
            type(obj['EntitySets']) == ListType, "EntitySets is an array")
    ...
    def testCaseRetrieveLinkJSON(self):
        ...
        self.assertTrue(
            obj["uri"] == "http://host/service.svc/Customers('ALFKI')", "Bad customer link")
    ...
    def testCaseRetrieveMediaResource(self):
        ...
        self.assertTrue(request.responseHeaders['DATASERVICEVERSION'].startswith(
            "2.0;"), "DataServiceVersion 2.0 expected")
        self.assertTrue(http.MediaRange.from_str("text/plain ; charset=iso-8859-1").MatchMediaType(
            http.MediaType.from_str(request.responseHeaders['CONTENT-TYPE'])))
        self.assertTrue("ETAG" in request.responseHeaders, "Entity set ETag")
        self.assertTrue(request.responseCode == 200)
        self.assertTrue(unicode(request.wfile.getvalue(), "iso-8859-1") == unicode(
            'An opening line written in a Caf\xc3\xa9', 'utf-8'), "media resource characters")
    ...
    def testCaseUpdateEntity(self):
        ...
        self.assertTrue(request.responseHeaders['DATASERVICEVERSION'].startswith(
            "2.0;"), "DataServiceVersion 2.0 expected")
        self.assertFalse(
            "ETAG" in request.responseHeaders, "Entity set Orders has no ETag")
        self.assertTrue(
            len(request.wfile.getvalue()) == 0, "Update must return 0 bytes")
        # now go behind the scenes to check the update really worked!
        orders = self.ds['SampleModel.SampleEntities.Orders']
    ...
    def testCaseUpdateValue(self):
        ...
        with customers.OpenCollection() as collection:
            customer = collection['ALFKI']
            self.assertTrue(
                customer['CompanyName'].value == u"Caf\xe9 Incorporated")
    ...
    def testCaseDeleteEntity(self):
        ...
        with orders.OpenCollection() as collection:
            order = collection[1]
            self.assertTrue(
                order['Customer'].GetEntity() is None, "order no longer linked to customer")
        customers = self.ds['SampleModel.SampleEntities.Customers']
        with customers.OpenCollection() as collection:
            for customer in collection.itervalues():
                self.assertFalse(
                    customer['CustomerID'].value == 'ALFKI', "Customer no longer exists")
        ...
        with customers.OpenCollection() as collection:
            ...
            with customer['Orders'].OpenCollection() as orders:
                ...
                for order in orders.itervalues():
                    self.assertFalse(
                        order['OrderID'].value == 1, "Order(1) not linked")
