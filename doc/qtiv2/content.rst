...
Many of the basic classes are drawn directly from the :py:mod:`html40_19991224`
module, as a result there are slight modifications to some of the abstract base
class definitions. See :py:class:`~html40_19991224.InlineMixin`,
:py:class:`~html40_19991224.BlockMixin` and
:py:class:`~html40_19991224.FlowMixin`; there is no class corresponding to the
objectFlow concept (see :py:class:`~html40_19991224.Object` for more
...
Again, these classes are defined in the accompanying :py:mod:`html40_19991224`
