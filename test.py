...
from PyAssess.ims.qti import test_asi
suite.addTest(test_asi.suite())
from PyAssess.ims.qti import test_questestinterop
suite.addTest(test_questestinterop.suite())
